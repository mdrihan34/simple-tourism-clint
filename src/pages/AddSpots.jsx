...
console.log(user)
    const handleAddSports = e =>{
      ...
      e.preventDefault()
        ...
        const newSpots = { image, spotName,countryName,location,description,cost,seasonality,travelTime,totalVisitors,userEmail,userName}
        console.log(newSpots)
        fetch('https://simple-tourism-scerver.vercel.app/spots',{
          method: 'POST',
          headers:{
  ...
  return (
    <div>
      <form onSubmit={handleAddSports} className="bg-[#F4F3F0] p-10">
        <div className="text-center pb-10">
          <h3 className="text-3xl font-bold text-black">Add Tourists Sports</h3>
        ...
        <div className="md:grid grid-cols-3 mb-5  gap-4">
          ...
          <div className="form-control">
            <label className="label">
              <span className="label-text font-bold text-xl text-black">User Email:</span>
            </label>
            <label className="input-group">
              <input
                className="input input-bordered bg-white w-full text-black  font-bold"
                type="text"
          ...
          <div className="form-control">
            <label className="label">
              <span className="label-text font-bold text-xl text-black">User Name:</span>
            </label>
            <label className="input-group">
              <input 
                className="input input-bordered bg-white w-full text-black  font-bold "
