...
const AllSpot = ({spote}) => {
    const { _id, image, spotName,countryName,location,description,cost,seasonality,travelTime,totalVisitors,userEmail,userName} = spote
  ...
  <div className="flex items-center gap-1">  
    ...
    <h4 className="texl-xl font-semibold">{location}</h4>
      ...
      <div className=" justify-end border-t-2 mt-2 pt-5">
       
       {/* <Link to={`/viewDetails/${_id}`}> 
       <button className="btn mt-2 btn-primary text-xl">View Details</button>
       </Link> */}
       <Link to={`/viewDetails/${_id}`}>
